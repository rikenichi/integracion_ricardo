...
class ConvenioB2BAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'perfil_cliente', 'porcentaje_descuento', 'activo', 'fecha_inicio', 'fecha_fin', 'creado_en')
    list_filter = ('activo',)
    search_fields = ('nombre', 'perfil_cliente__usuario__username', 'perfil_cliente__usuario__email')
    raw_id_fields = ('perfil_cliente',)
