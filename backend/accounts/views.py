...
def descuento_b2b_para_usuario(user):
    """Retorna el porcentaje de descuento activo del convenio B2B del usuario.
    Devuelve 0 si no tiene convenio, si está inactivo o fuera de fechas."""
    ...
    def post(self, request):
        ...
        pedido = Pedido.objects.create(
            ...
            datos={
                ...
                'descuento_pct': pct_descuento if detalles_respuesta else 0,
            },
        )
