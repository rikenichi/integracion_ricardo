...
def _inyectar_precio_b2b(data_list, pct_descuento):
    """Agrega precio_final, descuento_porcentaje y tiene_convenio a cada producto."""
    result = []
...
class CatalogoProductoView(APIView):
    def get(self, request):
        ...
        return Response(_inyectar_precio_b2b(serializer.data, pct))
...
class ProductoDetalleView(APIView):
    def get(self, request, codigo):
        ...
        pct = descuento_b2b_para_usuario(request.user) if request.user.is_authenticated else 0
        data = _inyectar_precio_b2b([serializer.data], pct)
