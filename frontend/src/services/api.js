...
const DEMO_AUDITORIA = [
  {
    ...
    accion: 'revision_interna',
    descripcion: 'Evento de revisión interna para seguimiento de auditoría del sistema.',
...
function normalizarProducto(item) {
  ...
  const base = {
    ...
    precio_final: item.precio_final ?? null,
    descuento_porcentaje: item.descuento_porcentaje ?? 0,
    tiene_convenio: item.tiene_convenio ?? false,
    precio,
